...
## 0.4.x — Player
- Player OSD, audio/subtitle menus and playback controls.

## 0.5.x — Full client polish
- Login, settings, dashboard, dialogs, notifications and edge cases.

## 0.9.x — Stabilization
- Cross-device compatibility, accessibility and performance.

## 1.0.0 — First stable complete CyberFlix skin
